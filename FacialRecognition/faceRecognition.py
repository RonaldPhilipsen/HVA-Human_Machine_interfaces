...
subjects = ["", "Arnout", "Ferdy", "Gerben", "Jurriaan", "Martijn", "Mathijs", "Mitchel E", "Patrick F", "Patrick H", "Robbin", "Tim V", "Wiebe", "Yoni"]
...
faces, labels = prepare_training_data("training_photos")
print("Data prepared")
...
#load test images
test_img1 = cv2.imread("test_photos/1.jpg")
test_img2 = cv2.imread("test_photos/2.jpg")
